...
<ul>
    <li><a target="_blank" href="https://basic-example.auth.pilcrowonpaper.com">Basic auth example</a>: An open-source example website that implements email address and password authentication following best practices.</li>
    <li><a target="_blank" href="https://passwordless-example.auth.pilcrowonpaper.com">Passwordless auth example</a>: An open-source example website that implements email code sign-in and passkeys following best practices.</li>
